...
import hero from '../../assets/images/custom/robot-1.png'
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            <div className="appie-hero-content appie-hero-content-8">
                                <h1 className="appie-title">Serve Up Success: Total Restaurant Solutions.</h1>
                                <p>
                                    we offers comprehensive and fully automated delivery services for restaurants, aiming to enhance efficiency and success in the food industry.
                                </p>
                                {/* <ul>
                                    <li>
                                        <a href="#">
